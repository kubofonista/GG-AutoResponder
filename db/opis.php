...
<!-- menu -->
						...
						<li class="page current_page"><a href="opis.php">Opis AutoRespondera</a></li>
...
<!-- body -->
					<h1>Zmień opis AutoRespondera</h1>
					<div style="background: #FFFFDD; padding: 10px; margin: 6px; border: 1px dashed #000;"><i><b>Info:</b> Tutaj możesz ustawić opis oraz status jaki będzie wyświetlany, gdy nie będziesz połączyony z siecią Gadu-Gadu.</i>
					</div>
					<br />
					<?php
					if($_POST) {
						...
						echo "<b>Ustawiono pomyślnie!</b><br />";
					}
					?>
					<form action="" method="POST">
						<b>Opis:</b><br />
						<textarea name="opis" cols="60" rows="5">[Nieosiagalny] </textarea><br />
						<b>Status:</b>
							<select name="typ">
								<option value="away">Zaraz wracam</option>
								<option value="back">Dostępny</option>

								<option value="dnd">Nie przeszkadzać</option>
