...
if($_POST['clear'] == 'true') {
	file_put_contents('wiadomosci.txt','');
}
?>
...
<!-- menu -->
						...
						<li class="page current_page"><a href="wiadomosci.php">Lista wiadomości</a></li>
...
<!-- body -->
					<h1>Zobacz listę wiadomości</h1>
					<div style="background: #FFFFDD; padding: 10px; margin: 6px; border: 1px dashed #000;"><i><b>Info:</b> Lista zapisanych wiadomości, które zostały wysłane podczas, gdy nie byłeś połączyony z siecią Gadu-Gadu. Możesz ją wyczyścić za pomocą przycisku "Wyczyść listę wiadomości" znajdującego się pod listą.</i>
					</div>
					<br />
					<div style="background: #EDEDD2; padding: 10px; border: 1px dotted #A0522D;">
						<?php
						...
						<input type="submit" value="Wyczyść listę wiadomości" />
						</form>
<!-- body end -->
				</div>
