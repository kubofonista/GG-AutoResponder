 ...
 *
 * @version 2.2 $Id: PushConnection.php 2011-04-04 13:00:00Z mbaginski $
...
class PushConnection
{
	...
	function setStatus($statusDescription, $status='', $graphic=false)
	{
		...
		curl_setopt($ch, CURLOPT_HTTPHEADER, array('Token: '.$this->authorization->getToken()));
		curl_setopt($ch, CURLOPT_POSTFIELDS, 'status='.$h.((!empty($statusDescription)) ? '&desc='.$statusDescription : ''));
